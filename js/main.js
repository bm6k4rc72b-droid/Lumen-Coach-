...
route('/coach', () => import('./screens/coach.js'));
route('/program/:id', () => import('./screens/program.js'));
route('/labs', () => import('./screens/labs.js'));
route('/labsreport/:id', () => import('./screens/labsreport.js'));
route('/vitals', () => import('./screens/vitals.js'));
